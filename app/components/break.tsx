    ...
    return (
        <section className="mt-7 bg-[url('/background/break.png')]">
            <div className="container max-w-full py-9">
                <div>
                    <h3 className="break-title font-playfair text-[25px] text-white sm:text-[35px] md:leading-[55px] md:text-xl text-balance">
                        Gak perlu ragu lagi langsung pesan sekarang
                    </h3>
                    <button
